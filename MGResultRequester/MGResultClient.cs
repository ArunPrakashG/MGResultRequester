...
namespace MGResultRequester
{
	public class MGResultClient : IDisposable
	{
		...
		public MGResultClient(IWebProxy proxy = null)
		{
		...
		public async Task<bool> SaveAsHtmlFile(string html, string registeredNumber)
		{
